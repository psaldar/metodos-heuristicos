...
print('***'*20)
print('INICIA EJECUCION AG INCLUYENDO BUSQUEDA EXAHUSTIVA Y LOCAL')
time_ini = time.time()
best_mod, best_score, bes_mod_entrenado, historia_score = AG(X_train,
                                                              ...
                                                              escenario=1,
                                                              iteracion = 0,
                                                              desc = 'busquedaLocal_busquedaExhaustiva_Final',
                                                              BH = True,
                                                              LS = True, 
                                                              bin_cont = False,
...
with open(f'../data/output/resultado_LS_BH_Final.json', 'w') as json_file:
